...
<html>
  ...
  <body style="background-image: url('images/adminhome2.jpg'); background-repeat: no-repeat; background-size: cover;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto" style="font-size: 20px;">
      ...
      <li >
        <a class="nav-link"style="color: black;" href="view_seller.jsp">View Wholesaler</a>
      </li>
