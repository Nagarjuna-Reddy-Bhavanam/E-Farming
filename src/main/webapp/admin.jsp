...
<form action="login.jsp" style="width:300px;" class="f ">
  <h1 class="title" style="left:40%; padding: 30px; color: black">Admin Login</h1>

<label for="exampleInputEmail1" class="form-label" style="color: black;  font-weight:bold">Email</label>
...
<div class="b">
<button type="submit" class="btn btn-dark" style="margin-left: 60px;" >Login</button>
